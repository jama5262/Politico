from api.v2.utils.validations.validation import validate
...
class OfficeModel():
    def __init__(self, tableName, data, id):
    ...
    def getSpecificOffice(parameter_list):
    ...
    def editSpecificOffice(self, id):
    ...
    def deleteSpecificOffice(self, id):
